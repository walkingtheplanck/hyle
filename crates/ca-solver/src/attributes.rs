...
impl AttributeBuffer {
    ...
    fn set_next(&mut self, cell_index: usize, value: AttributeValue) {
        ...
        // guarantee type-correct writes. If a malformed write still reaches
        // this layer, drop it instead of panicking inside the step loop.
        ...
        match (self, value) {
            ...
            // Mismatches are contract violations upstream.
            _ => {}
        }
    }
